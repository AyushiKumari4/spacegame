...
var playButton,control
var lifePowerups,shipPowerups,speedPowerups

var backgroundSprite;
function preload(){
  bgImage2=loadImage("images/bgImage2.png")
  bgImage7=loadImage("images/bgImage7.png")
  bgImage8=loadImage("images/bgImage8.png")
  playButton=loadImage("images/play.png")
  ship2=loadImage("images/spaceShip2.jpg")
  //ship2.scale=0.5
...
ship9=loadImage("images/ship2.png")
  ...
  bgSound=loadSound("images/bgMusic.wav")
  shipPowerupS=loadSound("images/spaceS.mp3")
  speedPowerupS=loadSound("images/speedP.mp3")
...
//control=createSprite(width / 2, height - 300)
...
score+=20
 ...
 if(level==2){
  ...
  color("white")
  stroke("blue")
 text("LEVEL 1",width / 2, height - 600, 50, 50)
}
else if(level===4){
  bg.display(bgImage2)
  if(count===0){
...
gameState=END
  ...
  if (bg.sprite.y < camera.position.y - height / 2+120) {
